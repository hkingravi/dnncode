import numpy as np
from dnncode.classifiers import loss_hinge_reg, loss_softmax, hinge_loss_grad
...
class LinearSVM(LinearClassifier):
    ...
    def loss(self, X_batch, y_batch, reg):
        ...
        :param X_batch: M x dim batch matrix
        :param y_batch: M element label vector
...
def loss_svm(weights, data, labels, reg):
    ...
    :return:
    """
    loss_val = loss_hinge_reg(data=data, labels=labels, weights=weights, reg_val=reg)
    grad_val = hinge_loss_grad(data=data, labels=labels, weights=weights, reg_val=reg)
